			...
			<div id="pricing" className="container">
				<div>
					...
					<div className="plans d-flex">
						<div onClick={e => this.changePlan(e, false)} className={`plan plan-1 ${this.state.initialPlan === false ? 'active' : null}`}>
							...
							<hr className="mb-4" />
							<a href="/signin" className="btn btn-primary">Create Free Account</a>
						</div>
